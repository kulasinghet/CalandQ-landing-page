...
import {FaAngleRight, FaUsers, FaUserShield} from 'react-icons/fa'
								...
								<div className="col-lg-6">
									<div className="bg-white cyber-about-box mb-30 mb-lg-0">
										...
										<Link
											href="/about-us"
										>
											<a className="text-decoration-none text-dark">Explore
												more <i><FaAngleRight/></i></a>
										</Link>
									</div>
								</div>
								<div className="col-lg-6">
									<div className="bg-white cyber-about-box">
										...
										<p>
											Dramatically deliver distributed e-business and one-to-one and idea-sharing
											objectively.
										</p>
										<Link
											href="/about-us"
