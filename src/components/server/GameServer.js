				...
				<div className="row justify-content-center">
					<div className="col-lg-6">
						<div className="text-center mb-5">
							...
							<p className='text-off-white'>Give your Website the speed, security, and uptime it deserves
								and become part of the fastest Web Hosting Hostim.</p>
						</div>
					</div>
				</div>
				<div className="row justify-content-center">
						...
						<div className="game-card">
							<div className="card-top">
								...
								<h4 className='mt-4 mb-3'>Battlefield Bad Company-2
									Ranked Servers.</h4>
								<p className='m-0 text-off-white'>Our custom control panel allows you to configure and
									customize & Administrators.</p>
							</div>
