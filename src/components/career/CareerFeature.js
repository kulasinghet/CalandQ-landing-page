...
import {BiBriefcase, BiBuildingHouse, BiCurrentLocation, BiWallet,} from 'react-icons/bi';
          ...
          <div className="row justify-content-center">
            {careerJobCard.map((jobCard, i) => (
                <div key={i + 1} className="col-lg-6 col-md-12">
                  <div
                      className="text-decoration-none my-4 mt-xl-0 mt-lg-0 single-open-job p-5 bg-dark text-white d-block rounded-custom">
